...
interface MediaCodecWrapper {
  ...
  default void setOnFrameRenderedListener(MediaCodec.OnFrameRenderedListener listener, Handler handler) {
    throw new UnsupportedOperationException("Frame-render callbacks unavailable");
  }
