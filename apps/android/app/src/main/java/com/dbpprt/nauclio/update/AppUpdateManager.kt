package com.dbpprt.nauclio.update
...
import com.dbpprt.nauclio.BuildConfig
    ...
    fun installDownloadedUpdate() {
        ...
        try {
            ...
            val installIntent = Intent(Intent.ACTION_VIEW).apply {
                ...
                clipData = ClipData.newRawUri("Nauclio update", uri)
...
private class GitHubReleaseClient {
    ...
    private fun openConnection(url: String, accept: String, timeoutMs: Int): HttpURLConnection =
        (URL(url).openConnection() as HttpURLConnection).apply {
            ...
            setRequestProperty("User-Agent", "Nauclio-Android/${BuildConfig.VERSION_NAME}")
    ...
    private companion object {
        const val LATEST_RELEASE_URL = "https://api.github.com/repos/dbpprt/nauclio/releases/latest"
        const val APK_ASSET_NAME = "Nauclio-Android.apk"
...
private fun AppRelease.apkFileName(): String = "Nauclio-Android-$version.apk"
