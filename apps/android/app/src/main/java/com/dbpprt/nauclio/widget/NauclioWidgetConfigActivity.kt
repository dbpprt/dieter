...
class NauclioWidgetConfigActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            NauclioTheme {
                WidgetConfigScreen(
                    initial = NauclioWidgetPrefs.config(this, appWidgetId),
                    onCancel = { finish() },
                    onSave = { config ->
                        NauclioWidgetPrefs.saveConfig(this, appWidgetId, config)
                        NauclioActivityWidgetProvider.render(this, AppWidgetManager.getInstance(this), appWidgetId)
