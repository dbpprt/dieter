...
class WidgetDemoSeeder {
    ...
    fun seed() {
        ...
        val store = NauclioSyncStore(context)
        ...
        context.getSharedPreferences("nauclio_connection", Context.MODE_PRIVATE).edit()
            .putString("preferred_endpoint", endpointId)
            .putBoolean("desired_connected", false)
            .commit()
        context.getSharedPreferences("nauclio_widget", Context.MODE_PRIVATE).edit()
    ...
    fun requestPin() {
        ...
        manager.requestPinAppWidget(
            ComponentName(context, NauclioActivityWidgetProvider::class.java),
            null,
            null,
        )
