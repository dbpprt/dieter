...
extension NSAttributedString.Key {
    static let renderedCodeBlockSource = NSAttributedString.Key("RenderedCodeBlockSource")
    static let renderedCodeBlockLanguage = NSAttributedString.Key("RenderedCodeBlockLanguage")
    static let renderedCodeBlockRange = NSAttributedString.Key("RenderedCodeBlockRange")
