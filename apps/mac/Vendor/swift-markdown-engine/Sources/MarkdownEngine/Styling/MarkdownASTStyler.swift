...
enum MarkdownASTStyler {
    ...
    static func styleAttributes(
        ...
        renderedCodeBlockStarts: Set<Int> = [],
        ...
        let ctx = Ctx(
            ...
            renderedCodeBlockStarts: renderedCodeBlockStarts
        )
    ...
    private struct Ctx {
        ...
        let renderedCodeBlockStarts: Set<Int>
    ...
    private static func styleCodeBlock(range: NSRange, ctx: Ctx, into attrs: inout [StyledRange]) {
        guard !ctx.renderedCodeBlockStarts.contains(range.location) else { return }
