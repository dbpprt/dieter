...
open class Highlighter {
    ...
    */
    ...
    /**
     Creates a highlighter using resources from the supplied bundle.

     This supports hosts that package SwiftPM resource bundles somewhere other
     than the location assumed by SwiftPM's generated `Bundle.module` accessor.

     - Parameter bundle: The bundle containing `highlight.min.js` and theme CSS.
