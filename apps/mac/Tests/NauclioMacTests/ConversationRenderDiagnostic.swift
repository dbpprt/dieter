...
private func part(_ type: String, text: String = "", tool: String = "", callID: String = "") -> Nauclio_V1_MessagePart {
...
@Test @MainActor func conversationTimelineRendersWithBothReasoningStates() throws {
    var assistant = Nauclio_V1_UiMessage()
