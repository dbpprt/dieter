...
var rpcCommand = map[string]string{
	...
	"CreateCard": "card create", "CreateChat": "chat create", "ForkChat": "card fork", "ListChats": "chat list", "GetCard": "card show", "GetConversation": "card transcript", "PollConversation": "card poll", "WatchConversation": "card watch", "GetToolOutput": "card tool-output", "SendMessage": "card send", "RemoveQueuedMessage": "card queue remove", "AddComment": "card comment", "MoveCard": "card move", "StartCard": "card start", "SetCardLabels": "card labels", "CancelCard": "card cancel", "RenameCard": "card rename", "UpdateCard": "card update", "ArchiveCard": "card archive", "PinChat": "chat pin",
...
func TestEveryDaemonCLICommandHasOfflineHelp(t *testing.T) {
	paths := []string{
		...
		"card", "card create", "card list", "card show", "card context", "card transcript", "card poll", "card watch", "card tool-output", "card fork", "card send", "card queue", "card queue remove", "card comment", "card move", "card start", "card labels", "card cancel", "card rename", "card update", "card archive", "card unarchive", "card workspace",
