...
var rpcCommand = map[string]string{
	...
	"GetRemoteDesktopCapabilities": "screen capabilities", "GetRemoteDesktopSettings": "screen settings", "UpdateRemoteDesktopSettings": "screen update", "StartRemoteDesktop": "screen start", "SendRemoteDesktopSignal": "screen signal", "CloseRemoteDesktop": "screen close", "GetRemoteDesktopSession": "screen status", "UpdateRemoteDesktopSession": "screen configure",
