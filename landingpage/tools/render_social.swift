...
text("Close your", x: 60, top: 155, size: 63, ink: 0x1b211b)
text("laptop.", x: 60, top: 235, size: 63, ink: 0x1b211b)
text("Keep agents running.", x: 64, top: 341, size: 37, ink: 0x5f724b)
text("Headless agents. Your hosts. Open source.", x: 64, top: 452, size: 20, ink: 0x566052)
text("getdieter.com", x: 64, top: 553, size: 17, ink: 0x566052)
image("images/screenshots/macos-board.png", x: 664, top: 231, width: 472, height: 298, radius: 8)
